...
-- ----------------------------
BEGIN;
INSERT INTO `t_admin` VALUES (1, 'root', '290421b48e4430573fa15d5a9d4f42f4', 1, 'lqjxm666@163.com', 'Muxi_k', 1609330779, 1609330779, NULL);
INSERT INTO `t_admin` VALUES (2, 'test', '4fd0ae9f6c7638ac36e4d55585a78881', 1, 'Test@gmail.com', 'Test', 1609405272, 1609405272, NULL);
COMMIT;
...
INSERT INTO `t_category` VALUES (4, '友人', '/link', 1, 3, 0, 1, 1609167190, 1609581220, NULL, NULL);
INSERT INTO `t_category` VALUES (5, 'PHP', NULL, 0, 2, 2, 1, 1609167190, 1, NULL, NULL);
INSERT INTO `t_category` VALUES (6, 'JavaScript', NULL, 0, 1, 2, 1, 1609167190, 1, NULL, NULL);
INSERT INTO `t_category` VALUES (7, '琐事\n', NULL, 0, 2, 3, 1, 1609167190, 1, NULL, NULL);
INSERT INTO `t_category` VALUES (17, '关于', '/about', 1, 3, 0, 1, 1609167190, 1, NULL, NULL);
INSERT INTO `t_category` VALUES (19, '碎碎念', 'http://blog.im/admin/index', 1, 3, 3, 1, 1609167190, 1609167190, NULL, NULL);
...
INSERT INTO `t_category` VALUES (22, 'GNU/Linux', NULL, 0, 0, 2, 1, 1609675920, 1609675920, NULL, 'linux');
COMMIT;
...
INSERT INTO `t_link` VALUES (3, '菜鸟教程', '学习使我快乐', 0, 'https://static.runoob.com/images/favicon.ico', 'https://www.runoob.com/', 1, 1609380926, 1609380926, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES (1, 'user1', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'lqjxm666@163.com', 0, 1609480927, 1609480927, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_web` VALUES (1, 'Muxi_k\'s Blog', 'Muxi_k\'s Blog', 5, '路虽远，行则必达 事虽难，做则必成', 'Muxi_k,muxik,Muxi_k\' Blog', 'Muxi_k 的小站', '/static/upload/20210104/e3725d59b6649d14f18ee1bbd6f5011f.jpeg', 'lqjxm666@163.com', 0, 'Copyright ©2020 PureBlog v2.0 All Rights Reserved', 1, NULL);
COMMIT;
